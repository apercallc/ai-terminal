  ...
  return (
    <div className="status-bar">
      <div className="status-left">
        <span className={`status-state ${stateClass}`}>{stateLabel}</span>
      ...
      <div className="status-right">
        <span
          ...
          title={
            mode === "safe"
              ? "Safe Mode: commands require approval"
              : "Auto Mode: commands run automatically"
          }
        >
        ...
        <button
          className={`status-btn ${isRecording ? "recording" : ""}`}
