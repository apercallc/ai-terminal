...
const BUILTIN_COMMANDS: CommandSuggestion[] = [
  ...
  },
  {
    id: "python3",
    command: "python3",
    description: "Run Python 3 interpreter",
    category: "python",
    frequency: 0,
  },
  {
  ...
  },
  {
    id: "tail-f",
    command: "tail -f",
    description: "Follow file contents in real-time",
    category: "utility",
    frequency: 0,
  },
  {
...
export class SuggestionEngine {
  ...
  parsePathInput(
    input: string,
  ): { baseCommand: string; partialPath: string; dirToList: string; prefix: string } | null {
